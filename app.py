...
class People(MongoAPI):
    def __init__(self) -> None:
        super().__init__()
        self.collection = self.db.peoples
        
        

class Author(MongoAPI):
    def __init__(self) -> None:
        super().__init__()
...
class Schema(MongoAPI):
    def __init__(self, collectionName, attributes: Dict[str, Union[AttributeDict, List[AttributeDict]]]) -> None:
        super().__init__()
        # Assign the collection to the current object from the collection db
        self.collection = self.db[collectionName]
        self.attributes = attributes
        
    def __validate__(self, data, querytype):
        ## Validate the data attributes
        if querytype == 'insert_one':
            pass
        elif querytype == 'insert_many':
            pass
        elif querytype == 'update_one':
            pass
        elif querytype == 'update_many':
            pass
        else:
            pass
        pass
